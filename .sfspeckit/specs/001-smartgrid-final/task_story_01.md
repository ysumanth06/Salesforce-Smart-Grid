...
|-------|-----------------|-----------------|
| Apex | `sf-apex` | `force-app/main/default/classes/SmartGridController.cls` |
| Test | `sf-testing` | `force-app/main/default/classes/SmartGridControllerTest.cls` |
| LWC | `sf-lwc` | `force-app/main/default/lwc/smartDataGrid/` |
