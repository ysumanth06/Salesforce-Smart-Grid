...
### AIAgentSession (ssot**AIAgentSession**dlm) ✅ T6 Verified
...
### AIAgentSessionParticipant (ssot**AIAgentSessionParticipant**dlm) ✅ Verified
...
### AIAgentInteraction (ssot**AIAgentInteraction**dlm) ✅ T6 Verified
...
### AIAgentInteractionMessage (ssot**AiAgentInteractionMessage**dlm) ✅ T6 Verified
...
### AIAgentInteractionStep (ssot**AIAgentInteractionStep**dlm) ✅ T6 Verified
...
### AIAgentMoment (ssot**AiAgentMoment**dlm) ✅ T6 Verified
...
### AIAgentMomentInteraction (ssot**AiAgentMomentInteraction**dlm) ✅ NEW
...
### AIAgentTagDefinition (ssot**AiAgentTagDefinition**dlm) ✅ Verified
...
### AIAgentTag (ssot**AiAgentTag**dlm) ✅ Verified
...
### AIAgentTagDefinitionAssociation (ssot**AiAgentTagDefinitionAssociation**dlm) ✅ Verified
...
### AIAgentTagAssociation (ssot**AiAgentTagAssociation**dlm) ✅ Verified
...
### GenAIGeneration (GenAIGeneration\_\_dlm)
...
### GenAIContentQuality (GenAIContentQuality\_\_dlm)
...
| `parent__c`             | Text     | FK to GenAIGeneration.generationId\_\_c |
...
### GenAIContentCategory (GenAIContentCategory\_\_dlm)
...
| ----------------- | -------- | --------------------------------- |
| `id__c`           | Text     | Primary key                       |
| `parent__c`       | Text     | FK to GenAIContentQuality.id\_\_c |
...
### GenAIGatewayRequest (GenAIGatewayRequest\_\_dlm)
...
### GenAIGatewayResponse (GenAIGatewayResponse\_\_dlm)
...
### GenAIFeedback (GenAIFeedback\_\_dlm)
...
### GenAIFeedbackDetail (GenAIFeedbackDetail\_\_dlm)
