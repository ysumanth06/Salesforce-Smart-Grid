...
Suggest next steps:
- If clarifications needed: "Run `/sfspeckit-clarify` to resolve open questions"
- If spec is clear: "Run `/sfspeckit-plan` to create the technical implementation plan"
