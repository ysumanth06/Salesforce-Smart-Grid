...
description: "TPO and Architect review of generated story files before Jira creation. Validates dependency graph, deployment order, merge conflict risks, and story boundaries. Run after /sfspeckit-tasks."
---
